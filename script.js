 //This fetches meals from the api and returns it
...
// To make a favourite meal array if it does not exist already in local storage
if (localStorage.getItem("favouritesList") == null) {
    localStorage.setItem("favouritesList", JSON.stringify([]));
}


// This shows meal cards below the search bar
...
//To show details of the the meals
...
//To add or remove meals from Favourite section
